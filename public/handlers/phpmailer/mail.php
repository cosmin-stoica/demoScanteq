...
try {
   ...
   /* $mail->Host       = 'smtp.hostinger.com';                     //Set the SMTP server to send through
    ...
    $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
    $mail->Username   = 'davidklaus53@gmail.com';                     //SMTP username
    $mail->Password   = 'Bitchule123';  
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
	$mail->SMTPDebug  = 0;
    $mail->Priority    = 1;
    //Recipients
    $mail->setFrom('from@example.com', 'Sito');
    $mail->addAddress('davidklaus53@gmail.com', 'sss'); 
    $mail->addAddress('davidklaus53@gmail.com', 'mio');     //Add a recipient
    $mail->addReplyTo('cosmin.stoica5@gmail.com', 'Information');
